import PocketBase, { LocalAuthStore, Admin, User } from "pocketbase";
// ---
...
const client = new PocketBase(import.meta.env.PB_BACKEND_URL, "en-US", new AppAuthStore("pb_admin_auth"));

if (client.authStore.model instanceof Admin) {
    setAdmin(client.authStore.model);
} else if (client.authStore.model instanceof User) {
